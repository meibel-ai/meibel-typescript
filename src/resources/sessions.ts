 ...
 * @throws {ApiError} If the request fails
 */
  async *sendChatMessageStream(sessionId: string, body: models.ChatMessageRequest): AsyncIterable<models.ConnectedEvent | models.StatusEvent | models.ToolCallEvent | models.ToolResultEvent | models.PartialResponseEvent | models.CompletionEvent | models.ErrorEvent> {
